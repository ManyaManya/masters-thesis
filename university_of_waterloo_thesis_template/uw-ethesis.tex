...
\input{chapter-background-cnts.tex}

\input{chapter-background-hcpcf.tex}
\input{subchapter-modecoupling.tex}

\input{chapter-fiberfilling.tex}

\input{chapter-background-icg.tex}
\input{chapter-icg-results.tex}

\input{chapter-bandgap-overlap.tex}
\input{chapter-cnt-results.tex}

\input{conclusion.tex}
\input{chapter-background-ecdl.tex}
%----------------------------------------------------------------------
% END MATERIAL
