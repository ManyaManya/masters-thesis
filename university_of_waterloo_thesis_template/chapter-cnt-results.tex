...
\begin{figure}[htb!]
	\centering
	\includegraphics[width=1.5cm, height=2.5cm]{./Figures/CNT\_Measured/DIH2O\_CNTs.png}
	\caption{CNT sample}
	\label{fig:sample}
\end{figure}
\clearpage
...
\end{figure}
\subsection{Unsorted CNT sample}
Because of the reduction of fluorescence in H${}_2$O, a sample was prepared in D${}_2$O without sorting.  
\subsubsection{Sample History}
\begin{figure}[htb!]
	\centering
	\includegraphics[width=4cm, height=3cm]{./Figures/CNT\_Measured/D2O\_CNTs.jpg}
	\caption{CNT sample}
